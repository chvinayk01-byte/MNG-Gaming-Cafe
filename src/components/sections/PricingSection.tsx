      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-heading text-3xl font-black uppercase text-white sm:text-5xl">
            GAME TIME. <span className="text-[#52ab98]">YOUR WAY.</span>
          </h2>
          <p className="mt-3 text-sm text-[#c8d8e4]">
            Flexible gaming session packages designed for casual matches or marathon gaming sessions.
          </p>
        </div>
            ...
            {activePlans.map((plan) => (
              <div
                ...
                className={`relative flex flex-col justify-between rounded-3xl border p-8 transition-all duration-300 ${
                  plan.isFeatured
                    ? 'border-[#52ab98] bg-[#132128] shadow-teal-glow scale-105 z-10'
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <h3 className="font-heading text-xl font-extrabold uppercase text-white">{plan.name}</h3>
                    <div className="rounded-lg bg-white/5 px-2.5 py-1 text-[10px] font-bold text-[#52ab98] uppercase">
                      {plan.duration}
                    </div>
                  </div>
                  ...
                  <p className="text-xs text-[#c8d8e4] leading-relaxed border-t border-white/10 pt-4 mb-6">
                    {plan.description}
                  </p>
                  ...
                  <div className="space-y-2 text-xs text-[#c8d8e4]/80">
                    ...
                    <div className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-[#52ab98] shrink-0" />
                      <span>High-speed competitive lounge setups</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-4 border-t border-white/5">
                  <a
                    href={`https://wa.me/${businessInfo.phone.replace(/[^0-9]/g, '')}?text=Hi%20MNG%20Gaming%20Cafe,%20I%20want%20to%20enquire%20about%20the%20${encodeURIComponent(plan.name)}%20package.`}
                    target="_blank"
